...
const Home = function () {
  ...
  this.games = [
    ...
    },
    {
      ...
      icon: "basketball-legends/logo.png",
    ...
    },
    {
      ...
      icon: "football-legends/logo.png",
