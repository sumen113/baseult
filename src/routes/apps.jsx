  ...
  this.games = [
    {
      name: "Suggest an App",
      icon: "suggest2.png",
      link: "https://docs.google.com/forms/d/e/1FAIpQLSdnc2mQAQeMW4o_tK_g8yrVgqSXc8jgystrptRDe6krxXFKxg/viewform?usp=header",
      newTab: true,
      goldBorder: false,
    },
    {
      name: "S-Movies",
      icon: "s-movies/logo.png",
      link: "/s-movies",
      newTab: false,
      goldBorder: true,
    }
