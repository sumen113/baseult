...
const Home = function () {
    ...
    this.windows = null;
    this.search = null;
    this.sidebar = localStorage.getItem("@nano/sidebar") == "true";
            ...
            if (platDependentAltOrCtrl && !e.shiftKey && !e.metaKey) {
                ...
                switch (e.key) {
                    case "a":
                        ...
                        break;
                    case "g":
                        window.location.href = "https://worried-timi-pixarc-db03c996.koyeb.app/games";
                        break;
                    case "s":
        ...
        <div>
            ...
            <div class="flex justify-center fixed bottom-0 right-0 left-0">
                <div class="flex items-center flex-1 gap-2 bg-Base rounded-[26px] p-1.5 my-2 mx-5 max-w-3xl shadow">
                    ...
                    <button
                        on:click={() => window.location.href = "https://worried-timi-pixarc-db03c996.koyeb.app/games"}
                        aria-label="Games"
